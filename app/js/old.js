   ...
   //Login Page
    $("form").submit (function (e) {
        ...
        if (!Store.worksheets.ritwiks) {
            var ritwiksCellFeedUrl = $("entry:icontains('form responses 1') link[rel='http://schemas.google.com/spreadsheets/2006#listfeed']", Store.worksheets.all).attr("href");
    ...
    var login = function (email, password) {
        ...
        $(".container").load ("partials/old.html", function () {
            window.initHomePage ();
        });
    };
    ...
    window.initHomePage = function () {
        ...
        $table.on("click", "tr", function () {
           var emailAddress = $(this).find("td").eq(6).text();
